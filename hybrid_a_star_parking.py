...
def main():
    ...
    #     ox.append(20.0)
    #     oy.append(i)
    for i in range(int((map_height-parking_height)/2)):
        ox.append(50.0)
        oy.append(60.0 - i)
    for i in range(parking_height):
        ox.append(50.0+parking_width)
        oy.append(35 - i)
    for i in range(int((map_height-parking_height)/2)):
        ox.append(50.0)
        oy.append(i)

    for i in range(parking_width):
        ox.append(50.0+i)
        oy.append(35)
    for i in range(parking_width+1):
        ox.append(50.0+i)
        oy.append(25)

    # Set Initial parameters
    start = [48.0, 10.0, np.deg2rad(90.0)]
    goal = [53.0, 30.0, np.deg2rad(90.0)]
